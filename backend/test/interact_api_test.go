...
func TestFavorite(t *testing.T) {
	...
	feedResp := e.GET("/ningmeng/feed/").Expect().Status(http.StatusOK).JSON().Object()
	...
	favoriteResp := e.POST("/ningmeng/favorite/action/").
	...
	favoriteListResp := e.GET("/ningmeng/favorite/list/").
...
func TestComment(t *testing.T) {
	...
	addCommentResp := e.POST("/ningmeng/comment/action/").
	...
	commentListResp := e.GET("/ningmeng/comment/list/").
	...
	delCommentResp := e.POST("/ningmeng/comment/action/").

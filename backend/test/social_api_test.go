...
func TestRelation(t *testing.T) {
	...
	relationResp := e.POST("/ningmeng/relation/action/").
	...
	followListResp := e.GET("/ningmeng/relation/follow/list/").
	...
	followerListResp := e.GET("/ningmeng/relation/follower/list/").
...
func TestChat(t *testing.T) {
	...
	messageResp := e.POST("/ningmeng/message/action/").
	...
	chatResp := e.GET("/ningmeng/message/chat/").
